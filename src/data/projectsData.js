export const projectsData = [
  ...
  },
  {
    ...
    tags: ['LabVIEW', 'NI','NI', 'DSP', 'HIL', 'HART', 'Python', 'Test Automation'],
    additional_tags: ['Firmware', 'Microprocessor', 'Microcontroller', 'Git', 'Microsoft Office', 'UART', 'JTAG', 'Schematics', 'Arduino', 'ARM Cortex','Markdown','Digital Signal Processing'],
  ...
  },
  {
    ...
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'SOC', 'Zynq', 'ARM Cortex', 'Ethernet', 'USB', 'SPI', 'I2C', 'UART', 'IoT', 'TCP/IP', 'Linux', 'PetaLinux', 'Ubuntu', 'Microprocessor', 'Microcontroller', 'VHDL', 'Verilog', 'Embedded C', 'C', 'TCL', 'IoT', 'Linux', 'Ubuntu', 'Petalinux', 'Texas Instruments', 'Silicon Labs', 'Microsoft Office', 'Micro SD', 'CPLD'],
  ...
  },
  {
    ...
    tags: ['Zynq 7000 SoC', 'Vivado', 'Vitis', 'Embedded C', 'Verilog', 'BIST', 'Petalinux', 'FSBL', 'Raspberry Pi', 'LoRaWAN', 'PCIe', 'Micro SD',],
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'JTAG', 'SOC', 'Zynq', 'ARM Cortex', 'Ethernet', 'USB', 'SPI', 'I2C', 'UART', 'IoT', 'TCP/IP', 'Linux', 'PetaLinux', 'Ubuntu', 'Microprocessor', 'Microcontroller', 'VHDL', 'Verilog', 'Embedded C', 'C', 'TCL', 'IoT', 'Linux', 'Ubuntu', 'Petalinux', 'Texas Instruments', 'Silicon Labs','Microsoft Office', 'Docker',],
  ...
  },
  {
    ...
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'UART', 'JTAG', 'TCL', 'Microsoft Office', 'Silicon Labs', 'C', 'C++', 'PicoBlaze', 'Assembler', 'Visual Studio', 'SystemVerilog', 'Xilinx ISE', 'Xilinx SDK', 'VivadoHLS', 'Digital Signal Processing'],
  ...
  },
  {
    ...
    additional_tags: ['Firmware', 'Git', 'Microprocessor', 'Microcontroller', 'Microsoft Office'],
  ...
  },
  {
    ...
    tags: ['Python', 'Audio Processing', 'Multithreading', 'FFMPEG', 'GUI', 'Git', 'Markdown'],
    additional_tags: ['DSP'],
  ...
  },
  {
    ...
    tags: ['Altera Quartus', 'FPGA', 'VHDL', 'ModelSim', 'MATLAB', 'DSP', 'TCL', 'Active-HDL'],
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'JTAG', 'Microsoft Office', 'Digital Signal Processing'],
  ...
  },
  {
    ...
    additional_tags: ['Firmware', 'C', 'C++', 'Git', 'Microsoft Office'],
  ...
  },
  {
    ...
    additional_tags: ['FPGA', 'Git', 'Schematics', 'UART', 'JTAG', 'Microsoft Office', 'Qt'],
  ...
  },
  {
    ...
    additional_tags: ['Firmware', 'JTAG', 'Microsoft Office',],
