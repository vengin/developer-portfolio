export const projectsData = [
  ...
  },
  {
    ...
    additional_tags: ['Firmware', 'Microprocessor', 'Microcontroller', 'Git', 'Microsoft Office', 'UART', 'JTAG', 'Schematics', 'Arduino', 'ARM Cortex','Markdown','Digital Signal Processing', 'NI'],
  ...
  },
  {
    ...
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'JTAG', 'SOC', 'Zynq', 'ARM Cortex', 'Ethernet', 'USB', 'SPI', 'I2C', 'UART', 'IoT', 'TCP/IP', 'Linux', 'PetaLinux', 'Ubuntu', 'Microprocessor', 'Microcontroller', 'VHDL', 'Verilog', 'Embedded C', 'C', 'TCL', 'IoT', 'Linux', 'Ubuntu', 'Petalinux', 'Texas Instruments', 'Silicon Labs','Microsoft Office', 'Docker', 'DDR'],
  ...
  },
  {
    ...
    tags: ['LabVIEW', 'Verilog', 'Embedded C', 'FPGA', 'Quartus', 'Xilinx ISE', 'Xilinx SDK', 'NIOS', 'Modelsim', 'TCL'],
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'UART', 'JTAG', 'Microsoft Office', 'Ethernet', 'TCP/IP', 'SPI', 'I2C', 'UART', 'Liinux', 'NI'],
  ...
  },
  {
    ...
    tags: ['LabVIEW','Quartus', 'NIOS', 'Embedded C', 'Altera FPGA', 'Nios', 'Test Automation', 'Python'],
    additional_tags: ['FPGA', 'Firmware', 'Git', 'Schematics', 'UART', 'JTAG', 'Microsoft Office', 'SPI', 'I2C', 'UART', 'NI'],
